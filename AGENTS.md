...
- In the 1868 game, endings lead to a review of an immutable completed-run snapshot before replay. Preserve the previous completed run across replay resets, and show only already discovered notes and the chronological conversation, without new hints or internal scores. Ending controls must retain dark backgrounds, gold borders and legible cream text at mobile widths.
