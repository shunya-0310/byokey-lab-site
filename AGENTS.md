...
- In the 1868 game, endings use a dedicated scrolling result screen and a canonical settlement snapshot. Describe accepted promises without claiming pending obligations were fulfilled. The primary CTA leads to `/games/edo-1868/review` before replay. Preserve the immutable previous completed run across replay resets and show only discovered notes and chronological conversation, without new hints or internal scores. Result/review controls use gold backgrounds and dark text with at least 4.5:1 contrast in every state at 320–430px widths. Historical-fiction notices belong in Important Matters, not endings.
